...
public class ColourMeanShiftTest {
    ...
    public void shouldShiftTowardsMean() {
        ...
        Assert.assertEquals(2, shift.x); // New centre is at the centre of the bottom right quadrant, i.e. a positive x-shit.
        Assert.assertEquals(2, shift.y); // New centre is at the centre of the bottom right quadrant, i.e. a positive y-shit.
    }

...
public class BasicColourHistogramTest {
    private final int redIndex = 0;
    private final int greenIndex = 1;
    private final int blueIndex = 2;
    ...
    @Before
    public void setUp() {
        underTest = ColourHistogramFactory.basicInstance(binWidth);
    }
    ...
    private void testHistogramFillingWithNonBackgroundPixel(int[][] pixelCoordinates) {
        final int rgb = ColourHelper.getRgb(127, 127, 127);
        ...
        final int n = 52;
        final int[] singleBin = new int[]{25, 25, 25, pixelCoordinates.length};
